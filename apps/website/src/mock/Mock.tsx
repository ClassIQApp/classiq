...
function App() {
    ...
    async function uploadMaterial(file: File) {
        ...
        try {
            ...
            alert("The API server is not running. Make sure the backend is running on port 4000.");
        }
    }
    ...
    function toggleLecture() {
        ...
        if (nextState) {
            ...
            setTranscript("The lecture is paused. Start the lecture to continue the transcript.");

            setTopic("Lecture paused");

            setExplanation("The AI assistant will continue analyzing the lecture when the lecture session is started again.");
        }
    }
        ...
        <div className="app-shell">
            ...
            <aside className="sidebar">
                ...
                <nav className="side-nav">
                    ...
                    <button className={`nav-item ${activeNav === "Courses" ? "active" : ""}`} onClick={() => setActiveNav("Courses")}>
                        <span className="nav-icon">□</span>
                        <span>Courses</span>
                    </button>
            ...
            <div className="main-shell">
                ...
                <header className="main-header">
                    <div className="header-right">
                        <button className="instructor-button">♧ &nbsp; Instructor Mode</button>
                ...
                <main className="dashboard">
                        ...
                        <>
                            <section className="lecture-stage">
                                ...
                                <div className="stage-content">
                                    <h1>{topic || "No lecture selected"}</h1>

                                    <div className="stage-meta">
                                        {topic ? `Lecture session • ${lectureTime}` : "Select a course and lecture to begin"}
                                    </div>
                                </div>
                            ...
                            <section className="content-grid">
                                <div className="transcript-card card">
                                    <div className="tabs">
                                        <button className="tab active">Live Transcript</button>

                                        <button className="tab">Lecture Notes</button>
                                    </div>

                                    <article className="transcript-entry current">
                                        <div className="timestamp">00:11</div>
                                    ...
                                    <div className="lecture-controls">
                                        ...
                                        >
                                            {recording ? "Ⅱ  Pause" : "▷  Start Lecture"}
                                        </button>

                                        <div className="control-status">
                                            <span className={recording ? "control-live-dot" : "control-gray-dot"} />

                                            {recording ? "Lecture in progress" : "Lecture Ready"}
                                        </div>
                                ...
                                <aside className="right-column">
                                    ...
                                    <div className="card ai-card">
                                        ...
                                        <div className="insight-section">
                                            <span className="section-label">SIMPLE EXPLANATION</span>
                                        ...
                                        <div className="insight-section last">
                                            <span className="section-label">RELATED MATERIAL</span>
                                    ...
                                    <div className="card materials-card">
                                        ...
                                        <div className="materials-list">
                                            {displayedMaterials.map((material) => (
                                                <button className="material-row" key={material.id}>
                                                    <div className="material-icon">▤</div>

                                                    <div className="material-info">
                                                        <strong>{material.name}</strong>

                                                        <small>{material.uploaded ? "Uploaded material" : "Course material"}</small>
                                                    </div>
                    ...
                    {activeNav === "Materials" && (
                        <section className="page-card card">
                            ...
                            <p className="page-description">
                                Upload lecture slides, notes, readings, study guides, and other course resources. The AI assistant will use
                                these materials to provide better explanations during the lecture.
                            </p>
                            ...
                            <div className="library-grid">
                                {displayedMaterials.map((material) => (
                                    <div className="library-item" key={material.id}>
                                        <div className="library-icon">▤</div>

                                        <div>
                                            <strong>{material.name}</strong>

                                            <p>{material.uploaded ? "Uploaded material" : "Course material"}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
                    ...
                    {activeNav === "Courses" && (
                        <section className="page-card card">
                            ...
                            <p className="page-description">Your courses and lecture sessions will appear here.</p>
                    ...
                    {activeNav === "Settings" && (
                        <section className="page-card card">
                            ...
                            <p className="page-description">
                                Configure lecture preferences, AI assistance, captions, and account settings.
                            </p>
                            ...
                            <div className="settings-list">
                                <div className="setting-row">
                                    <div>
                                        ...
                                        <p>Use uploaded course material when generating explanations.</p>
                                    </div>
                                ...
                                <div className="setting-row">
                                    <div>
                                        ...
                                        <p>Display the prepared lecture transcript during class.</p>
                                    </div>
